package com.example.blackcoffer.listener;
...
public class StepSkipListener implements SkipListener<Data, Number> {
    ...
    public void onSkipInProcess(Data customer, Throwable throwable) {
